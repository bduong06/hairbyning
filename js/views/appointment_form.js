    ...
    <div class="container-fluid text-center">
        ...
        <div id="booking-form-container" class="container">
            <form id="booking-form"  autocomplete="off">
                ...
                <div class="row mb-4">
                    <div class="col-sm-9">
                        <label class="col-sm-3 col-form-label fw-normal" for="name_field">Full name*</label>
                        <input type="char" class="form-control" id="name_field" name="name" required="1" placeholder="e.g. John Smith" value="<%= name %>">
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col-sm-9">
                ...
                <div class="row mb-4">
                    <div class="col-sm-9">
                        <label class="col-sm-3 col-form-label fw-normal" for="phone_field">Phone number*</label>
